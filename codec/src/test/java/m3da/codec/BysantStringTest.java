...
public class BysantStringTest {
    ...
    private final Map<String, String> globalStrings = Maps.newHashMap();
    {
        ...
        globalStrings.put(StringUtils.repeat("a", 66593), "29ffff" + StringUtils.repeat("61", 65535) + "0422"
                + StringUtils.repeat("61", 1058) + "0000");
    }
    ...
    private final Map<String, String> uisStrings = Maps.newHashMap();
    {
        ...
        uisStrings.put(StringUtils.repeat("a", 67632), "3affff" + StringUtils.repeat("61", 65535) + "0831"
                + StringUtils.repeat("61", 2097) + "0000");
    }

    @Test
    public void decode_global_string() throws DecoderException {
    ...
    @Test
    public void decode_uis_string() throws DecoderException {
