...
public class BysantNumberTest {
    ...
    @Test
    public void decode_global_number() throws DecoderException {
    ...
    @Test
    public void decode_number_number() throws DecoderException {
    ...
    @Test
    public void decode_uis_number() throws DecoderException {
    ...
    private void testDecode(Map<Number, String> samples, BysantContext ctx) throws DecoderException {
