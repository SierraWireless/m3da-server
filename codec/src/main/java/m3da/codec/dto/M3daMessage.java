...
/**
 * The M3DA::Message object is a container object that enables the data transmission between two peers. See the protocol
 * specification for more details.
 */
public class M3daMessage implements M3daBodyMessage {
